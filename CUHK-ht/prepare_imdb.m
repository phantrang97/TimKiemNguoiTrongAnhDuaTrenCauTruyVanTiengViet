...
imdb.images.set = set;
% change to full path
imdb.images.data = cellfun(@(x) sprintf('/home/thuypham/huyentrang/kl/dataset/CUHK-ht/imgs_256/%sjpg',x(1:end-3)), file_path,'UniformOutput',false);;
...
imdb.rgbMean = [99.6290,93.5328,89.3086];
